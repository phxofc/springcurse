package br.com.pedro.springcurse.exceptions.handler;
...
import br.com.pedro.springcurse.exceptions.ExceptionResponse;
import br.com.pedro.springcurse.exceptions.ResourceNotFoundException;

@ControllerAdvice //usa sempre que precisa concentrar um tratamento em todos os controles
@RestController
public class CustomizedResponseEntityExceptionHandler  extends ResponseEntityExceptionHandler{
    ...
    @ExceptionHandler(InvalidJwtAuthenticationExceptionException.class)
